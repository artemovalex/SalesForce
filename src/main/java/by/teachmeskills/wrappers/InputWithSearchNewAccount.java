...
public class InputWithSearchNewAccount {
    WebDriver driver;
    String label;

    public InputWithSearchNewAccount(WebDriver driver, String label) {
        this.driver = driver;
        this.label = label;
    }

    public InputWithSearchNewAccount fillIn(String text) {
